...
import com.konkerlabs.platform.registry.core.common.model.behaviors.DeviceURIDealer;
import com.konkerlabs.platform.registry.core.common.model.behaviors.RESTDestinationURIDealer;
...
public class EventRouteServiceImpl implements EventRouteService {
    ...
    private Map<String,Object[]> applyRouteActorValidations(Application application, EventRoute.RouteActor actor) {
