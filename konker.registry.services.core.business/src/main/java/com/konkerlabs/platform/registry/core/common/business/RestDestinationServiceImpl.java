...
import com.konkerlabs.platform.registry.core.common.api.AbstractURLBlacklistValidation;
...
import com.konkerlabs.platform.registry.core.common.business.api.RestDestinationService;
import com.konkerlabs.platform.registry.core.common.model.Application;
import com.konkerlabs.platform.registry.core.common.model.RestDestination;
...
import com.konkerlabs.platform.registry.core.common.repositories.ApplicationRepository;
import com.konkerlabs.platform.registry.core.common.repositories.EventRouteRepository;
import com.konkerlabs.platform.registry.core.common.repositories.RestDestinationRepository;
...
public class RestDestinationServiceImpl
		extends AbstractURLBlacklistValidation
		implements RestDestinationService {
	...
	public ServiceResponse<RestDestination> register(final Tenant tenant, final Application application, RestDestination destination) {
		...
		if (!Optional.ofNullable(destination.getType()).isPresent()) {
			destination.setType(RestDestination.RestDestinationType.FORWARD_MESSAGE);
		}
	...
	public ServiceResponse<RestDestination> update(final Tenant tenant, final Application application, String guid, RestDestination destination) {
		...
		if (destination.getType().equals(RestDestination.RestDestinationType.FORWARD_MESSAGE)) {
